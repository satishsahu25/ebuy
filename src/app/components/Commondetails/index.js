...
import { addtocart } from "@/app/api/services/cart";
...
export default function Commondetails({item}){
    ...
    const { complevelloader, 
        user,
        setcomplevelloader,setshowcartmodal}=useContext(GlobalContext);
    ...
    <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
      ...
      <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
        <div className="flex items-end">
          ...
          {item.onSale === "yes" ? (
            <h1 className="text-3xl font-bold mr-2 font-semibold text-red-700">{`$${(
              item.price -
        ...
        >
        {
          complevelloader&&complevelloader.loading?<ComponentLevelLoader
            text={"Adding to cart..."}
            color={"#ffffff"}
