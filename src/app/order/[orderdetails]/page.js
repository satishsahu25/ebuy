...
import { getOrderdetailsforuser } from "@/app/api/services/order";
...
export default function OrderDetails() {
  ...
  async function EXorderdetails() {
    const res = await getOrderdetailsforuser(params["orderdetails"]);
    ...
    <div className="py-14 px-4 md:px-6">
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
        ...
        <div className="flex flex-col gap-5">
          ...
          <button
            onClick={() => router.push(`/`)}
            className="mt-10 mr-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
          >
            Shop Again
          </button>
        </div>
